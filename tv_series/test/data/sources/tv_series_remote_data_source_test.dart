...
void main() {
  ...
  final tResponse = readJson('dummy/tv_response.json');
  final tDetailData = dummyTvDetailResponse;
  final tDetailResponse = readJson('dummy/tv_detail_response.json');
  final tSeasonData = dummySeasonResponse;
  final tSeasonResponse = readJson('dummy/tv_season_response.json');
